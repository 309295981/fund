...
import com.shenqi.mybatis.plugin.EclipseShellCallback;
...
public class GeneratorBuilder {
	...
	public static void main(String[] args) throws SAXException {
		...
		File configFile = new File(GeneratorBuilder.class.getResource(xml)
				.getFile().replace("/target/classes","/mybatis"));
